...
let main (l1_1037(*-:{v:Int | true}*)) (l2_1038(*-:{v:Int | true}*)) =
	...
	let rec zip_1030 zip_without_checking_10770 x_DO_NOT_CARE_1079 x_DO_NOT_CARE_1080 x_DO_NOT_CARE_1081 xs_1031 prev_set_flag_zip_1062 s_prev_zip_xs_1060 s_prev_zip_ys_1061 ys_1032 =
	  let u =if prev_set_flag_zip_1062 then
	         ...
	         zip_without_checking_10770 x_DO_NOT_CARE_1079 x_DO_NOT_CARE_1080
  ...
  assert(zip_1030 zip_without_checking_1077 set_flag_zip_1063m s_zip_xs_1058m s_zip_ys_1059m l1_1037
      set_flag_zip_1063m s_zip_xs_1058m s_zip_ys_1059m l2_1038 >= 0)
