...
let main prefv prefp prefn = 
  let ev = fun k0 q acc evx ->
             if ((q = 0) && (evx > 0)) then k0 1 evx () 
                  ...
                  else if ((q = 1) && (evx > acc)) then k0 1 evx () 
                       else if ((q = 2) && (evx < acc)) then k0 2 evx () 
                            else k0 3 evx () in 
  let ev_assert = fun k1 q0 acc0 x0 ->
                    let k33 q acc x26 =
                      let x28 = 3 in 
                      let x27 = q < x28 in  let x25 = () in 
                            ...
                            let k29 q28 acc28 res16 =
                              ...
                              let k32 q31 acc31 res19 =
                                ...
                                let k31 q30 acc30 res18 =
                                  let x23 = 1 in 
                                  let x22 = neg - x23 in  let k30 q29 acc29 res17 =
                                                            k27 q29 acc29 res17 in 
                                                          res18 k30 q30 acc30 x22 in 
                                res19 k31 q31 acc31 x20 in 
