...
let rec compute vv cfg2 = ((fun bound1 cfg3 ->
                              ((fun inc cfg4 ->
...
let main (v:int(*-:{cur_v:Int | true = true}*)) (w:int(*-:{cur_v:Int | true = true}*)) (m:int(*-:{cur_v:Int | true = true}*)) = (match let f0 = ((fun t cfg16 ->
