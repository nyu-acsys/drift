...
let rec toChurch_1038 toChurch_without x_DO_NOT_CARE_1381 x_DO_NOT_CARE_1382 x_DO_NOT_CARE_1383 n_1039 x_DO_NOT_CARE_1378 x_DO_NOT_CARE_1379 x_DO_NOT_CARE_1380 f_EXPARAM_1119 prev_set_flag_toChurch_1361 s_prev_toChurch_n_1358 s_prev_toChurch_f_EXPARAM_1359 f_1040 =
 let u = if prev_set_flag_toChurch_1361 then
          if ((0 * 1) + (1 * s_prev_toChurch_n_1358)) +
           ...
           ()
             in
        toChurch_without x_DO_NOT_CARE_1381
...
let main x_1043 =
 ...
 let s_toChurch_f_EXPARAM_1356m = 0 in
   if x_1043 >= 0 then
     let tos_1044 =
       toChurch_1038 toChurch_without_checking_1376 set_flag_toChurch_1362m s_toChurch_n_1355m
